...
### 1.1 最優先開発目標 (Core Goals)
本システムは、以下の2点を最低限確実に遂行することを開発の絶対目標とする。
1.  **座標の正確な認識**: 盤面上の石の位置や変化図の座標を1点の狂いもなく把握し、解説に反映させること。
2.  **愚形の認識と論理的説明**: 「アキ三角」などの効率の悪い形を知識ベースに基づいて正確に特定し、なぜそれが悪いのかを級位者にも分かる言葉で論理的に説明できること。
