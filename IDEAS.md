...
- [ ] **対話型シミュレーション (What-if Analysis)**: AI が自ら「もしここに打ったら？」を試行できるツールの追加。
- [ ] **局面比較ツール (Batch Comparison)**: A 図と B 図の解析結果を一度に取得し、差分を言語化。
- [ ] **エンジン・メトリクスの公開**: 探索速度や負荷状況を AI に提供し、状況に応じた解説を促す。
- [ ] **プロンプトの Resource 移管**: システムプロンプトを常設リソース化し、コンテキストウィンドウを節約。

---
*最終更新: 2026-01-19 (Rev 44.0 Updated)*
