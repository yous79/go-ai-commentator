...
class AnalysisModule(McpModuleBase):
    ...
    def katago_analyze(self, history: Optional[List[Move]] = None, board_size: Optional[int] = None) -> str:
        ...
        """
        try:
            target_history, target_size = self.resolve_context(history, board_size)
    ...
    def simulate_scenario(self, sequence: List[Move], board_size: Optional[int] = None) -> str:
        ...
        """
        try:
            base_history, target_size = self.resolve_context(None, board_size)
